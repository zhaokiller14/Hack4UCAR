...
export default function CreateUserPage() {
  ...
  const filteredInstitutions = useMemo(
    () => institutions.filter((institution) => institution.organization_id === selectedOrganizationId),
    ...
    <div className="max-w-2xl mx-auto p-8 bg-white rounded-xl shadow-sm border border-gray-100 mt-10">
      ...
      <form action={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#1B4F6B] mb-1">Organization</label>
            <select
