  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#F7F6F3] px-6 py-10 text-[#0D2B3E]">
      ...
      <div className="relative z-10 w-full max-w-2xl rounded-2xl border border-[#1B4F6B]/15 bg-white/90 p-8 shadow-[0_30px_80px_-40px_rgba(13,43,62,0.45)] backdrop-blur-sm md:p-12">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#1B4F6B]">
          UCAR
        </p>
        <h1 className="mt-3 text-5xl font-bold tracking-tight text-[#1B4F6B] md:text-6xl">
          404
        </h1>
        <h2 className="mt-4 text-2xl font-semibold text-[#0D2B3E]">
          Page introuvable
        </h2>
        <p className="mt-3 max-w-xl text-base text-[#0D2B3E]/70">
          Le lien que vous avez saisi n&apos;existe pas ou a ete deplace.
          Verifiez l&apos;URL, puis revenez a l&apos;accueil pour continuer.
        </p>
